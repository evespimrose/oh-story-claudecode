...
> 단편 전용 AI 문체 제거 규칙이다. 판치에·치마오·헤이옌·염선의 대중 단편을 대상으로 하며, 전통 문학도 장편도 아니다.
> 장편용 AI 문체 제거 규칙은 단편의 매력을 잘못 삭제할 수 있으므로 단편에 적용하지 않는다. 이 파일이 단편의 기준이다.

---

## 기본 입장: 단편은 감정 상품이다

단편은 직설적인 공감으로 독자를 붙잡으며 절제된 여백에 의존하지 않는다. 단편의 AI 문체 제거는 한 가지만 한다. **공허한 감정 요약문은 지우고, 구체적인 반응이 뒷받침하는 감정은 남긴다.**
...
## 1. 감정 쓰기: 직접 써도 되지만 뒤에 장면 속 구체적인 행동을 붙인다
...
## 단편 AI 문체 제거 자가 점검표(각 절을 쓴 뒤 항목별 확인)
