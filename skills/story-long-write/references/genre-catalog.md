...
> **용도**: 작품을 분석하고 개요를 작성할 때 대조 자료로 사용한다. 아래의 경로표에서 알맞은 프레임을 고르는 숙련된 웹소설 구조 분석 자료이며, 구조 비율과 감정 박자를 엄격히 따른다.
...
| 이야기의 핵심이 다음과 같다면... | 이 프레임을 사용한다 | 비고 |
|---|---|---|
| 남자가 여자를 상처 입히고, 그녀가 떠난 뒤 후회하지만 되돌리지 못한다 | **追妻火葬场** | 여주가 떠난 뒤 돌아보지 않는 것이 핵심이다 |
| 前世惨死，重生利用信息差复仇 | **重生复仇** | 反派需分层嵌套 |
| 伴侣出轨/算计，觉醒独立 | **小三/婚恋** | 발견 과정에는 반드시 긴장감을 둔다 |
| 奇葩/恶霸欺压老实人，恶有恶报 | **世情** | 靠细节不靠大事件 |
| 여주가 학대받다 죽고, 남주가 죽은 뒤 후회한다 | **死人文学** | 핵심은 「이미 늦었다」다 |
| 특별한 만남 뒤 남주가 적극적으로 구애하고 아낀다 | **霸总/甜宠** | 달콤함의 밀도가 몰입도를 결정한다 |
| 底层崛起，升级打怪（都市+武道） | **都市高武** | 金钱驱动+分层地图 |
| 废材/落魄天才，修仙世界登顶 | **仙侠/玄幻** | 力量体系必须清晰 |
| 独特金手指/创意设定为核心卖点 | **脑洞文** | 核心梗决定赛道 |
| 주인공에게 재능은 없지만 신중한 계산으로 살아남는다(수련물) | **凡人流** | 이익과 손해의 저울질이 핵심 방식이다 |
...
| 幕 | 占比 | 内容要点 |
|----|------|----------|
| 압박 형성 | 40% | 冷暴力/出轨(具体事件)→最后忍让→平静离开 |
| 爆点 | 35% | 丈夫后悔→妻子新生活→追妻被拒→信息差释放 |
| 落定 | 25% | 火葬场→妻子最终选择→一句话定调 |

**기법**：前期虐越狠后期越爽；妻子至少被拒绝两次；丈夫视角悔恨比妻子视角坚强更有冲击；钩子=信息差+打脸
...
| 幕 | 占比 | 内容要点 |
|----|------|----------|
| 압박 형성 | 35% | 重生节点→前世闪回→第一个不同选择→信息差建优势 |
| 爆点 | 40% | 逐步拆解仇人→两个打脸名场面→仇人反击落空→前世未知真相 |
| 落定 | 25% | 终极复仇→弥补遗憾→新生开始 |

**기법**：不能太顺利要有变数；打脸分层递进；前世闪回有选择不倒完；钩子=信息差+暗牌+打脸
...
| 幕 | 占比 | 要点 |
|----|------|------|
| 압박 형성 | 40% | 균열을 암시한다→蛛丝马迹→确认→冷静(不是崩溃) |
| 爆点 | 35% | 暗中布局→表面周旋(戏剧张力)→摊牌 |
| 落定 | 25% | 法律/揭露/经济独立→渣男下场→新生 |

**기법**：발견 과정에는 반드시 긴장감을 둔다；아내는 전략을 지녀야 하며 순진하게 휘둘리는 인물이어서는 안 된다；갈고리 = 정보 격차 + 숨은 패 + 카운트다운
...
| 幕 | 占比 | 要点 |
|----|------|------|
| 압박 형성 | 40% | 困境→暴露事件→周围人态度→忍还是争 |
| 爆点 | 35% | 冲突升级→背叛/落井下石→反击→反转 |
| 落定 | 25% | 解决→人心揭示→成长→留白 |

**기법**：靠细节不靠大事件；人物不能非黑即白；钩子=代价+弱者+反转
...
| 幕 | 占比 | 要点 |
|----|------|------|
| 압박 형성 | 35% | 世界规则+主角位置→困境→核心设定→人物出场 |
| 爆点 | 40% | 修炼转折→正面交锋→大阴谋→关键反转 |
| 落定 | 25% | 终极对决(有策略有代价)→矛盾解决→仙侠留白 |

**기법**：世界观压缩到最少用事件带出；等级/功法3-5个概念足矣；冲突落在"情"非"力"；钩子=暗牌+反转+代价
...
| 幕 | 占比 | 要点 |
|----|------|------|
| 압박 형성 | 35% | 死亡事实→死者视角→最放不下的事→生者状态 |
| 爆点 | 40% | 回忆现实交叉→真相→反转→最扎心时刻 |
| 落定 | 25% | 放手或执念→生者继续或崩塌→安静画面→一句话/意象 |

**기법**：핵심은 「이미 늦었다」다；死者第一人称最有冲击；情绪克制越克制越扎心；钩子=代价+信息差+弱者
...
**关键**：달콤함의 밀도가 몰입도를 결정한다 | 宠要"别人做不到的方式" | 阻力不能太强(虐就跑偏)不能太弱(没张力) | 女主要独立闪光点

### 短篇（压缩三幕）

| 幕 | 占比 | 要点 |
|----|------|------|
| 압박 형성 | 30% | 女主困境→相遇→男主展露兴趣 |
...
### 关键维度
主角谨慎必须真实(不能嘴上说谨慎行为疯狂) | 이익과 손해의 저울질이 핵심 방식이다 | 配角有独立利益考量 | 伏笔和回收要精巧
